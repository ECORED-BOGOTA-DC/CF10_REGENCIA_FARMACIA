...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4 Partiendo de la definición del Decreto 780 del 2016 al Servicio Farmacéutico, como:
    ...
    p.mb-5 Se hace necesario contar con procesos que garanticen la calidad de estos medicamentos y dispositivos médicos y, así mismo, brinden tranquilidad al momento de su dispensación a los usuarios. 
      br
      br
