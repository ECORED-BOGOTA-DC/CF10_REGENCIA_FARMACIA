...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5(data-aos="fade-right") Es un documento oficial que resume las características del producto y evidencia las condiciones de uso autorizadas, simplificando la información científica precisa para los profesionales de la salud, de acuerdo con los estudios que respaldan su autorización. 
      br
      br
      |La información contendida en este formato, debe estar actualizada porque es un documento que permite modificaciones, ya sea por la compañía farmacéutica, el fabricante o por las autoridades sanitarias.
      br
      br
    ...
    p.mb-5(data-aos="fade-right") El contenido de la ficha técnica se encuentra descrito en el anexo II - Contenido de la ficha técnica o resumen de características del producto- del real decreto 1345 del 2007, pero La EMEA “A Guideline on Summary of Product Characteristics” [Directrices sobre el resumen de las características del producto] establece diez ítems estandarizados en todos los países de la UE:
    .col-lg-10.mx-auto.tarjeta.p-4.mb-5(style="overflow: hidden; background-color: #F7F6FE")
      ul.lista-ul--color.lista-ul--separador
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 1. Nombre del medicamento.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 2. Composición cualitativa y cuantitativa.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 3. Forma farmacéutica.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 4. Datos clínicos.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 5. Propiedades farmacológicas.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 6. Datos farmacéuticos.
        li
        ...
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 10. Fecha de revisión del texto.
        li
          p.mb-0.col.ps-4(data-aos="fade-right") En el caso de radiofármacos, además:
        li
          p.mb-0.col.ps-4(data-aos="fade-right") 11. Dosimetría.
        li
    ...
    .col-lg-10.mx-auto.tarjeta.p-4.py-lg-5.mb-5(style="overflow: hidden; background-color: #F7F6FE")
      ul.lista-ul--color.lista-ul--separador.mb-0.col-lg-10.mx-auto
        ...
        li.d-flex
          img(src="@/assets/curso/temas/decorador-2.svg" style="width: 25px; height: 25px;" data-aos="fade-right")
          p.mb-0.col.ps-4(data-aos="fade-left") No es la información que se encuentra en los vademécum.
        li.d-flex
          img(src="@/assets/curso/temas/decorador-2.svg" style="width: 25px; height: 25px;" data-aos="fade-right")
          p.mb-0.col.ps-4(data-aos="fade-left") No es la información que se encuentra en el Catálogo de Especialidades Farmacéuticas.
        li.d-flex.mb-0
          img(src="@/assets/curso/temas/decorador-2.svg" style="width: 25px; height: 25px;" data-aos="fade-right")
    ...
    .col-lg-10.mx-auto
      .col-lg-10.me-auto.tarjeta.p-4.mb-5(style="overflow: hidden; background-color: #F7F6FE")
        p.col-lg-7.mx-lg-auto.mb-0(data-aos="fade-right") 1. Carcinogenicidad.
          ...
          br
          |4. Tóxico para los órganos a bajas dosis.
          br
          |5. Genotoxicidad.
    ...
    .col-lg-10.mx-auto.tarjeta.p-4.mb-5(style="background-color: #CFF0F9; overflow: hidden;")
      ul.lista-ul--color.col-lg-11.ms-lg-auto
        li.d-flex.mb-4
          ...
          p.mb-0.ps-2(data-aos="fade-left") Gases: propileno, etanol, butano, helio, oxígeno, cloro, etc.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Líquidos inflamables: acetona, alcohol etílico, etc.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Sólidos inflamables: sodio, potasio, carburo, etc.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Sustancias comburentes y peróxidos: ácido nítrico, ácido sulfúrico, ácido clorhídrico, ácido fluorhídrico, peróxido de magnesio, etc.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
    ...
    p.mb-5(data-aos="fade-right") Las principales vías de exposición a estos son la vía dérmica (por contacto directo), la vía inhalatoria (exposición por inhalación) y la vía digestiva (por comer en el lugar contaminado). 
      br
      br
...
export default {
  ...
  data: () => ({
    datosSlyder: [
      {
        titulo: 'Medicamentos alopáticos',
        texto:
          'Estos pueden ser genéricos, de marca o comerciales, de control, esenciales, de venta bajo formula médica o venta libre.',
        imagen: require('@/assets/curso/temas/tema3/img-2.svg'),
      },
      {
      ...
      },
      {
        titulo: 'OTC',
        texto:
          'Son los medicamentos de venta libre, es decir, que no requieren de fórmula médica para ser adquiridos por los pacientes. A este grupo también se le suman los productos de cuidado personal y la higiene sanitaria, entre otros.',
        imagen: require('@/assets/curso/temas/tema3/img-6.svg'),
      },
      {
