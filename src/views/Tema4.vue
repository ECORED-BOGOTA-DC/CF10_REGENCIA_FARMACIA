...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .col-lg-10.mx-auto.tarjeta.p-4(style="background-color: #F7F6FE; overflow: hidden;")
      ...
      ul.lista-ul--color
        li.d-flex.mb-4
          ...
          p.mb-0.ps-2(data-aos="fade-left") <b>El trueque:</b> consiste en entregar una mercancía a cambio de otra.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
    ...
    .col-lg-10.mx-auto.tarjeta.p-4.mb-5(style="overflow: hidden; background-color: #F7F5FE;")(data-aos="fade-left")
      h4.mb-5 Tipos de mercancía según el orden
      LineaTiempoB.linea-tiempo-edit(:datos="datosLineaTiempoB")
    .col-lg-10.mx-auto.tarjeta.p-4(style="overflow: hidden; background-color: #F7F5FE;")(data-aos="fade-left")
    ...
    .d-flex.flex-wrap.col-xl-9.offset-xl-1
      ...
      p.col-lg-7.ps-lg-4(data-aos="fade-left") <b>La consolidación de la mercancía</b> es un servicio logístico que permite a la empresa reducir costos en el transporte de la mercancía, porque permite reunir distintas cargas, con embalajes diferentes o iguales y que vienen de distintas empresas, pero que comparten la misma ruta o destino.
        br
        br
        |Este proceso requiere de experiencia en logística y conocimiento de la clase de mercancía que se transporta y de las reglas relacionadas con ella. En ese sentido, a la hora de llenar un contenedor, es necesario conocer en volumen y peso de la carga, los embalajes, tipo de envases, condiciones de transporte, etc., todo con el fin de evitar sobrecargas y que toda la mercancía llegue en perfectas condiciones a su destino.
      p.mt-3.mb-5.w-100(data-aos="fade-right") Las siguientes son ventajas que tiene la consolidación de la mercancía:
      ul.lista-ul--color
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Permite ahorrar dinero en el transporte de mercancías.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Permite mejorar la competitividad de las empresas.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Permite la economía de escala en logística y la internacionalización de grandes, medianas y pequeñas  empresas.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Es un beneficio para todos los que participan en el proceso.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-2(data-aos="fade-left") Optimiza espacio.
        li.d-flex.mb-4
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
...
export default {
  ...
  data: () => ({
    ...
    datosLineaTiempoB2: [
      ...
      {
        titulo: 'No perecederas',
        texto: 'Para su conservación no requieren de refrigeración.',
        icono: require('@/assets/curso/temas/tema4/img-8.png'),
      },
      {
        titulo: 'Frágiles',
        texto:
          'Se pueden destruir con facilidad, por lo que requieren de especial cuidado en su manipulación y transporte.',
        icono: require('@/assets/curso/temas/tema4/img-9.png'),
      },
      {
        titulo: 'Peligrosas',
        texto:
          'Representan peligro por su composición química, por lo que son un riesgo para los individuos que las manipulan.',
        icono: require('@/assets/curso/temas/tema4/img-10.png'),
      },
      {
