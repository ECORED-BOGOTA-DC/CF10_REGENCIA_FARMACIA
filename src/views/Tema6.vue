...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      ...
      .col-lg-9.ps-lg-3
        p.mb-5(data-aos="fade-left") Se refiere al material necesario utilizado en el proceso de cubrir, proteger y perseverar las características y calidad de los productos farmacéuticos que serán transportados.
          br
          |El embalaje permite:
