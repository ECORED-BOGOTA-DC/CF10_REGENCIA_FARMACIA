    ...
    .tarjeta.p-4(style="background-color: #F7F6FE; overflow: hidden;")
      ...
      ul.lista-ul--color.mb-0
        li.d-flex.mb-0
          ...
          p.mb-0.ps-3.ps-md-5(data-aos="fade-left") <b>Alta seguridad:</b> son usados principalmente en contenedores marítimos y pueden ser en forma de tubo o metálicos con cable.
        li.d-flex.mb-0
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
          p.mb-0.ps-3.ps-md-5(data-aos="fade-left") <b>De seguridad:</b> son los que utilizan el resto de las industrias.
        li.d-flex.mb-0
          img.mb-auto.pt-1(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 14px" data-aos="fade-right")
